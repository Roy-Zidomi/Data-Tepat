...
const PERMISSIONS = {
  ...
  DECISION_LIST: [ROLES.ADMIN_MAIN, ROLES.ADMIN_STAFF, ROLES.PENGAWAS],
  DECISION_CREATE: [ROLES.ADMIN_MAIN, ROLES.ADMIN_STAFF],
  DECISION_UPDATE: [ROLES.ADMIN_MAIN, ROLES.ADMIN_STAFF],
  SCORING_RESULT_LIST: [ROLES.ADMIN_MAIN, ROLES.ADMIN_STAFF],
  ...
  // Complaints
  COMPLAINT_CREATE: [ROLES.WARGA, ROLES.PENGAWAS],
  COMPLAINT_LIST_OWN: [ROLES.WARGA, ROLES.PENGAWAS],
