...
const navStructure = [
  ...
  // 2. Data Warga (group) — admin_main full, relawan & warga limited
  {
    ...
    children: [
      { path: '/households', label: 'Rumah Tangga', icon: Home, roles: ['admin_main', 'admin_staff', 'pengawas', 'relawan'] },
      { path: '/family-members', label: 'Anggota Keluarga', icon: Users, roles: ['admin_main', 'relawan'] },
  ...
  // 3. Permohonan Bantuan (group)
  {
    ...
    children: [
      { path: '/applications', label: 'Daftar Permohonan', icon: FileText, roles: ['admin_main', 'admin_staff', 'pengawas'] },
